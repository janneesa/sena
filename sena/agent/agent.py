"""Core Agent class for Sena state machine orchestration.
...
from sena.agent.utils.helpers import get_system_instructions_path
from sena.agent.utils.logging import configure_logging, get_logger
