"""Database utilities for Sena using SQLite3.
...
from sena.agent.utils.helpers import get_workspace_root
...
def get_database_path() -> Path:
    """Return absolute path to `workspace/data/sena.db`.

    Host mode defaults to <project_root>/workspace/data/sena.db.
    Docker mode uses WORKSPACE_ROOT (for example /workspace/data/sena.db).
    """
    return get_workspace_root() / "data" / "sena.db"
